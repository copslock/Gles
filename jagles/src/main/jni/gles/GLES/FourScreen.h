...
#ifndef FISHEYE_FOURSCREEN_H
#define FISHEYE_FOURSCREEN_H

#include "OneScreen.h"
#include "Hemisphere.h"
#include "NormalPlay.h"

class FourScreen : public ISurface {
public:
    FourScreen(float aspect,void *mgn);
    ~FourScreen();
	...
	virtual void LoadOSDTexture(int w, int h, GLenum type, GLvoid *pixels) { mVideo[2]->LoadOSDTexture(w, h, type, pixels); };
